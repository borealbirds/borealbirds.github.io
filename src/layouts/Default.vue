    ...
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <g-link to="/species" class="text-copy-primary hover:text-gray-600">Species</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <div class="rounded-full py-2 px-4">
              <g-link to="/methods" class="text-copy-primary hover:text-gray-600">Methods</g-link>
            </div>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <div class="rounded-full py-2 px-4">
              <g-link to="https://borealbirds.ualberta.ca/" class="text-copy-primary hover:text-gray-600">Contact</g-link>
            </div>
          </li>
        </ul>
      </nav>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="https://github.com/borealbirds" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/borealbirds" target="_blank" class="text-white hover:text-gray-400">
